...
public class libvlc_chapter_description_t extends Structure {
	...
	public libvlc_chapter_description_t(long i_time_offset, long i_duration, Pointer psz_name) {
		super();
		this.i_time_offset = i_time_offset;
		this.i_duration = i_duration;
		this.psz_name = psz_name;
	}
	public libvlc_chapter_description_t(Pointer peer) {
		super(peer);
	}
